...
public class NEPhoneCallStateObserver {
    ...
    private PhoneCallStateEnum stateEnum = NEPhoneCallStateObserver.PhoneCallStateEnum.IDLE;

    private List<Observer<Integer>> localPhoneObservers = new ArrayList<>(1); // 本地电话的监听

    private static class InstanceHolder {
        public final static NEPhoneCallStateObserver instance = new NEPhoneCallStateObserver();
    }
