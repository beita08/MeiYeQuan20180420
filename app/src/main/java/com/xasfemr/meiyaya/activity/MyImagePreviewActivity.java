...
import com.xasfemr.meiyaya.adapter.MyImagePreviewAdapter;
import com.xasfemr.meiyaya.main.BaseActivity;

import java.util.List;

public class MyImagePreviewActivity extends BaseActivity implements ViewTreeObserver.OnPreDrawListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagePreviewAdapter = new MyImagePreviewAdapter(this, imageInfo);
