...
/**
 * BaseActivity为该项目所有activity的基类,实现activity的共有功能  //AppCompatActivity
 */
      ...
      /*
        *已下处理状态栏的问题
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (this instanceof MyImagePreviewActivity) {
            ...
            /*if (this instanceof UserPagerActivity) {
