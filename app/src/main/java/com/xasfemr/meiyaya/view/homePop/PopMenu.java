package com.xasfemr.meiyaya.view.homePop;

/**
 * Created by sen.luo on 2018/2/8.
 */
...
public class PopMenu {
    ...
    private void buildAnimateGridLayout() {
        ...
        mCloseIv.setImageResource(R.drawable.tab_add);
        mCloseIv.setPadding(UiUtils.dp2px(mActivity,10), UiUtils.dp2px(mActivity,10), UiUtils.dp2px(mActivity,10), UiUtils.dp2px(mActivity,10));
    ...
    private void showSubMenus(ViewGroup viewGroup) {
        ...
        mCloseIv.startAnimation(rotateAnimation);
    }
