 ...
 * ================================================
 */
public class MyImagePreviewAdapter extends PagerAdapter implements PhotoViewAttacher.OnPhotoTapListener {

    private List<ImageInfo> imageInfo;
    private Context context;
    private View currentView;

    public MyImagePreviewAdapter(Context context, @NonNull List<ImageInfo> imageInfo) {
        super();
    ...
    public void onPhotoTap(View view, float x, float y) {
        //((MyImagePreviewActivity) context).finishActivityAnim();
        ((MyImagePreviewActivity) context).finish();
    }
}