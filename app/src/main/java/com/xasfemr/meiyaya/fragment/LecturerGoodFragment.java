...
public class LecturerGoodFragment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(lecturerActivity, R.layout.fragment_lecturer_good, null);
        rvLectureGood = (RecyclerView) view.findViewById(R.id.rv_lecture_good);
        return view;
    ...
    public void initData() {
        ...
        rvLectureGood.setLayoutManager(new GridLayoutManager(lecturerActivity, 3));
        rvLectureGood.setAdapter(new LectureAdapter());
