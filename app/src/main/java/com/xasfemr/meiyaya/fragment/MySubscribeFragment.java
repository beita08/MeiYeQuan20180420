 ...
 * MySubscribeFragment是用来填充在MyCourseSubscribeActivity中的,所以也不在使用.
 */
public class MySubscribeFragment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mCourSubsActivity, R.layout.fragment_my_subscribe, null);
        rvMySubscribe = (RecyclerView) view.findViewById(R.id.rv_my_subscribe);
        return view;
    }
    ...
    public void initData() {
        ...
        rvMySubscribe.setLayoutManager(new GridLayoutManager(mCourSubsActivity,2));
        rvMySubscribe.setAdapter(new CourSubsAdapter());
    ...
    private class CourSubsAdapter extends RecyclerView.Adapter<CourSubsHolder>{
        ...
        public void onBindViewHolder(CourSubsHolder holder, int position) {
            holder.rlCourseInfo.setVisibility(View.VISIBLE);
        }
