package com.xasfemr.meiyaya.weight.keyboard;
...
public class KeyboardUtil {
    ...
    public KeyboardUtil(Activity activity,View view) {
        this(activity, false,view);
    }

    public KeyboardUtil(Activity activity, boolean ifRandom,View view) {
        this.mActivity = activity;
        this.mIfRandom = ifRandom;
        mKeyboardNumber = new Keyboard(mActivity, R.xml.keyboardnumber);
        mKeyboardView = (MyKeyBoardView) view.findViewById(R.id.keyboard_view);
    }
