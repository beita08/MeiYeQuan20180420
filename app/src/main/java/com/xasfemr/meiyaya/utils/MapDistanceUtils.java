...
/**
 * 根据两对经纬度算其距离
 * Created by sen.luo on 2018/3/15.
 */
...
public class MapDistanceUtils {
    ...
    private static MapDistanceUtils instance;

    public static synchronized MapDistanceUtils getInstance(){
        if(instance == null){
            instance = new MapDistanceUtils();
        }
        return instance;
    ...
    private String trans(double distance) {
        ...
        return (new DecimalFormat(".00").format(distance)) + (isBig ? "公里" : "米");
    }
