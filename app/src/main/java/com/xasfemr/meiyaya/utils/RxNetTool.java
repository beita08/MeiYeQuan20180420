        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    EventBus.getDefault().post("WIFI", GlobalConstants.EventBus.NETWORK_CHANGE_LISTENER);
//                    ToastUtil.showShort(context,"切换到wifi环境下");
                ...
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            netType = NETWORK_2G;
                            EventBus.getDefault().post("2G", GlobalConstants.EventBus.NETWORK_CHANGE_LISTENER);
//                            ToastUtil.showShort(context,"切换到2G环境下");
//                            RxToast.info("切换到2G环境下");
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            EventBus.getDefault().post("3G", GlobalConstants.EventBus.NETWORK_CHANGE_LISTENER);
//                            ToastUtil.showShort(context,"切换到3G环境下");
//                            RxToast.info("切换到3G环境下");
                        ...
                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
//                            ToastUtil.showShort(context,"切换到4G环境下");
                            EventBus.getDefault().post("4G", GlobalConstants.EventBus.NETWORK_CHANGE_LISTENER);
...
//                            RxToast.info("切换到4G环境下");
                        ...
                        default:
                            ...
                            ToastUtil.showShort(context,"未知网络");
//                            RxToast.normal("未知网络");
                    }
                    break;
                default:
...
//                    RxToast.normal("未知网络");
            ...
            EventBus.getDefault().post("fail", GlobalConstants.EventBus.NETWORK_CHANGE_LISTENER);
